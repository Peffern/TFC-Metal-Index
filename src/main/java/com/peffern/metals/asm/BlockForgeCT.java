 ...
 *
 */
public class BlockForgeCT implements IClassTransformer
{
	@Override
	public byte[] transform(String name, String transformedName, byte[] basicClass) 
	{
		if(name.equals("com.bioxx.tfc.Blocks.Devices.BlockForge"))
			...
			if((m.name.equals("createNewTileEntity")) && m.desc.equals("(Lnet/minecraft/world/World;I)Lnet/minecraft/tileentity/TileEntity;"))
			{
				...
				while(it.hasNext())
				{
					...
					if(insn instanceof TypeInsnNode)
					{
						...
						if(tinsn.desc.equals("com/bioxx/tfc/TileEntities/TEForge"))
						{
							TypeInsnNode newTinsn = new TypeInsnNode(tinsn.getOpcode(), "com/peffern/metals/TECustomForge");
					...
					else if(insn instanceof MethodInsnNode)
					{
						...
						if(minsn.owner.equals("com/bioxx/tfc/TileEntities/TEForge"))
						{
							MethodInsnNode newMinsn = new MethodInsnNode(minsn.getOpcode(), "com/peffern/metals/TECustomForge", minsn.name, minsn.desc, minsn.itf);
