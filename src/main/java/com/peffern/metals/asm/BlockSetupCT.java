			...
			if((m.name.equals("loadBlocks")) && m.desc.equals("()V"))
			{
				...
				while(it.hasNext())
				{
					...
					if(insn instanceof TypeInsnNode)
					{
						...
						{
							TypeInsnNode newTinsn = new TypeInsnNode(tinsn.getOpcode(), "com/peffern/metals/BlockCustomMetalSheet");
						...
						{
							TypeInsnNode newTinsn = new TypeInsnNode(tinsn.getOpcode(), "com/peffern/metals/BlockCustomMetalTrapDoor");
							m.instructions.insert(tinsn, newTinsn);
							m.instructions.remove(tinsn);
						}
					}
					else if(insn instanceof MethodInsnNode)
					{
						...
						{
							MethodInsnNode newMinsn = new MethodInsnNode(minsn.getOpcode(), "com/peffern/metals/BlockCustomMetalSheet", minsn.name, minsn.desc, minsn.itf);
						...
						{
							MethodInsnNode newMinsn = new MethodInsnNode(minsn.getOpcode(), "com/peffern/metals/BlockCustomMetalTrapDoor", minsn.name, minsn.desc, minsn.itf);
							m.instructions.insert(minsn, newMinsn);
							m.instructions.remove(minsn);
						}
					}
